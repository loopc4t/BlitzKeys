const sentences = [
  ...
  {
    question:
      "Would you please _____ your hair? It looks like you've just gotten out of bed.",
    options: ["comb", "curly", "radiant"],
    answer: "comb",
  },
  {
    question:
      "He has a _____ build - he's not particularly strong, but not especially skinny either.",
  ...
  {
    question:
      "His superiority _____ makes him impossible to work with because he won't listen to suggestions.",
    options: ["belief", "complex", "tendency"],
    answer: "complex",
  },
  {
    question:
      "I had to _____ my pride and apologize to Janet for overreacting to her criticism.",
  ...
  {
    question:
      "It's good to _____ others first, but not at the expense of your own well-being.",
    options: ["get", "put", "set"],
    answer: "put",
  },
  {
    question:
      "Most people who work as comedians have very _____ personalities.",
    options: ["outgoing", "tendency", "upcoming"],
    answer: "outgoing",
  },
  {
    question:
      "My brother is _____ shy, but I'm trying to encourage him to come out of his _____ .",
    options: ["painfully", "shell"], // Note: two blanks in original
    answer: "painfully", // Main answer for first blank
  },
  {
    question:
      "My daughter gets along with her classmates, but she has a competitive _____ when it comes to academics.",
    options: ["streak", "spot", "strip"],
    answer: "streak",
  },
  {
    question:
      "My husband forgives other people very easily; he's not one to _____ a grudge.",
  ...
  {
    question:
      "Working with a therapist has helped me overcome my problems with _____ self-esteem.",
    options: ["deep", "low", "small"],
    answer: "low",
  },
  {
    question:
      "You need to develop a _____ skin; you can't let every little comment upset you.",
  ...
  {
    question:
      "I was _____ surprised by the excellent customer service - that company really cares about its customers.",
    options: ["deeply", "pleasantly", "significantly"],
    answer: "pleasantly",
  },
  {
    question:
      "I'm sorry I _____ my temper with you yesterday. It was a really stressful day at work.",
    options: ["forgot", "lost", "wrecked"],
    answer: "lost",
  },
  {
    question:
      "Instead of confronting his issues, he _____ up his emotions and tries to pretend everything's OK.",
    options: ["bottles", "guards", "rolls"],
    answer: "bottles",
  },
  {
    question:
      "It's normal to go through a _____ of emotions after the end of a long-term relationship.",
  ...
  {
    question:
      "The boss was _____ annoyed when the employees told him about the problems.",
    options: ["pleasantly", "sickly", "visibly"],
    answer: "visibly",
  },
  {
    question:
      "The fans were seething with _____ when the team lost the game in the last 5 minutes.",
    options: ["anger", "disappointment", "temper"],
    answer: "anger",
  },
  {
    question:
      "We're _____ sorry, but we won't be able to go to your graduation.",
    options: ["badly", "horribly", "terribly"],
    answer: "terribly",
  },
  {
    question:
      "We're _____ grateful for all the help you've given us in this project.",
  ...
  {
    question:
      "I can't stand living with my parents; I need a place of my _____.",
    options: ["independent", "short-term", "own"],
    answer: "own",
  },
  {
    question:
      "I hope the apartment is _____, because I can't afford to buy appliances.",
    options: ["furnished", "decorated", "upscale"],
    answer: "furnished",
  },
  {
    question:
      "I was having so much fun during my semester abroad that I didn't feel _____ at all.",
  ...
  {
    question:
      "We're going to need a more _____ apartment now that we're going to have a baby.",
    options: ["spacious", "short-term", "widespread"],
    answer: "spacious",
  },
  {
    question:
      "We're _____ the bathroom, so you'll have to use the one on the second floor.",
    options: ["regenerating", "remodeling", "rejuvenating"],
    answer: "remodeling",
  },
  {
    question:
      "During the summer, our kids eat a lot of _____ food - popcorn, candy, ice cream, cookies, etc.",
    options: ["junk", "processed", "nourishing"],
    answer: "junk",
  },
  {
    question:
      "He got food _____ after eating some seafood from a street vendor.",
  ...
  {
    question:
      "Spinach is one of the most _____ vegetables - it's full of vitamins and minerals.",
  ...
  {
    question:
      "The food at this restaurant is all natural - they don't use any type of _____ food.",
  ...
  {
    question:
      "A movie from an amateur filmmaker was _____ for three awards at an international film festival.",
    options: ["based", "nominated", "presented"],
    answer: "nominated",
  },
  {
    question:
      "Did you see the _____ for the new Star Wars movie? It looks like it'll be awesome!",
  ...
  {
    question:
      "I didn't like the _____ of the movie; it just didn't seem believable.",
    options: ["close", "end", "finish"],
    answer: "end",
  },
  {
    question:
      "I enjoyed the book because I could really identify with the main _____.",
  ...
  {
    question:
      "It's an enjoyable _____, written in a humorous and relatable style.",
  ...
  {
    question:
      "The first movie was excellent, but the sequel got mediocre _____.",
  ...
  {
    question:
      "We couldn't get a ticket for _____ night - they were all sold out.",
  ...
  {
    question:
      "I'm not really musically _____, but I practice the violin every day.",
  ...
  {
    question:
      "My cousin's band is going on _____ next summer; they've lined up shows in eleven different states.",
    options: ["tour", "gig", "following"],
    answer: "tour",
  },
  {
    question:
      "Someone in the choir was singing _____, and it sounded terrible.",
  ...
  {
    question:
      "The singer has attracted quite a devoted _____ in Korea - her concerts there are always sold out.",
  ...
  {
    question:
      "This music is so slow it's putting me to sleep. Let's listen to something with a more _____ tempo.",
  ...
  {
    question:
      "Barbara has _____ a new world record, with 5 consecutive Olympic gold medals in judo.",
  ...
  {
    question:
      "If a soccer game is _____, they do penalty kicks to determine the winner.",
  ...
  {
    question:
      "The baseball team was unable to make a _____ and lost the game 5-2.",
    options: ["comeback", "setback", "takeback"],
    answer: "comeback",
  },
  {
    question:
      "The biker from Australia currently has the _____, but the bikers from Russia and Peru are close behind.",
  ...
  {
    question:
      "Tim Randall has _____ a personal best with his time of 23.04 seconds.",
  ...
  {
    question:
      "After my computer was stolen, I was so glad I had _____ all my data on an external hard drive.",
    options: ["backed up", "locked up", "started up"],
    answer: "backed up",
  },
  {
    question:
      "Could I use your computer for a minute? I'd like to _____ my e-mail.",
    options: ["check", "look", "verify"],
    answer: "check",
  },
  {
    question:
      "Do I need to _____ a special program to be able to view this video?",
  ...
  {
    question:
      "I can't check the event schedule online because the conference website seems to be _____.",
    options: ["off", "frozen", "down"],
    answer: "down",
  },
  {
    question:
      "If you want more space on your hard drive, you should _____ old files that you no longer need.",
  ...
  {
    question:
      "More and more people are _____ the web on their cell phones nowadays.",
    options: ["getting", "scanning", "surfing"],
    answer: "surfing",
  },
  {
    question:
      "My computer _____ when I have too many programs open at the same time.",
    options: ["down", "freezes", "infected"],
    answer: "freezes",
  },
  {
    question:
      "Never open attachments from people you don't know - they could _____ your computer with a virus.",
    options: ["disease", "infect", "lock up"],
    answer: "infect",
  },
  {
    question:
      "The boss wants everyone to _____ their computers before leaving work.",
  ...
  {
    question:
      "The trajectory of the country after 1930 is a _____ illustration of Smith's theory in action.",
  ...
  {
    question:
      "Greenpeace _____ five million dollars to help preserve the Atlantic rainforest.",
    options: ["raised", "rose"],
    answer: "raised",
  },
  {
  ...
  {
    question:
      "I can't believe I _____ $10 on a calculator that doesn't even work!",
    options: ["ruined", "wasted"],
    answer: "wasted",
  },
  {
    question:
      "I didn't have enough savings to pay my college tuition, so I had to _____ a student loan.",
    options: ["pick", "take out"],
    answer: "take out",
  },
  {
    question:
      "Sometimes your employer can pay your salary by _____ a deposit directly in your bank account.",
    options: ["doing", "making"],
    answer: "making",
  },
  {
    question:
      "I really admire rich people who _____ a large portion of their wealth to charity.",
    options: ["donate", "sponsor"],
    answer: "donate",
  },
  {
    question:
      "I try not to eat out at restaurants too often; I'm trying to _____ money.",
    options: ["keep", "save"],
    answer: "save",
  },
  {
    question:
      "Let's _____ money here at the airport so that we can get a taxi to the hotel.",
    options: ["exchange", "replace"],
    answer: "exchange",
  },
  {
    question:
      "My son _____ $50 for taking care of the neighbor's dogs over the weekend.",
    options: ["earned", "won"],
    answer: "earned",
  },
  {
    question:
      "We need to _____ a budget so that we don't end up spending more than we earn.",
    options: ["give", "make"],
    answer: "make",
  },
  {
  ...
  {
    question:
      "Organizing all these files is very _____; I wish I had someone to help me.",
    options: ["time-consuming", "pressing", "falling"],
    answer: "time-consuming",
  },
  {
    question:
      "Sarah _____ her hours as she entered her eighth month of pregnancy.",
  ...
  {
    question:
      "There is a strict _____ for the delivery of this shipment - it must arrive by January 1.",
  ...
  {
    question:
      "We've _____ on our English lessons; the class is on Lesson 10 but we're on Lesson 6.",
    options: ["fallen back", "fallen before", "fallen behind"],
    answer: "fallen behind",
  },
  {
    question:
      "You need to schedule your dentist appointment two weeks in _____.",
  ...
  {
    question:
      "His cell phone makes an _____ noise every time he gets a text message.",
    options: ["angering", "annoying", "incessant"],
    answer: "annoying",
  },
  {
    question:
      "I could tell Dan was still mad, as he glared at me in _____ silence.",
    options: ["stony", "strange", "stunned"],
    answer: "stony",
  },
  {
    question:
      "I wasn't able to relax on the beach because some teenagers had a stereo with music _____.",
  ...
  {
    question:
      "It's _____ quiet in that classroom - are the students taking a test?",
    options: ["eerily", "oddly", "sullen"],
    answer: "eerily",
  },
  {
    question:
      "My neighbor's dogs start _____ whenever someone walks past their house.",
  ...
  {
    question:
      "The _____ noise in the office makes it difficult to concentrate.",
  ...
  {
    question:
      "She always gets up early _____ the morning and goes to bed late at night.",
    options: [
      "about",
      "at",
      "by",
  ...
  {
    question:
      "My mother is abroad so my dad is taking care _____ us at the moment.",
    options: [
      "about",
      "at",
      "by",
  ...
  {
    question:
      "We have been searching _____ a web designer for a few weeks now.",
    options: [
      "about",
      "at",
      "by",
  ...
  {
    question:
      "I’m interested _____ basketball but I’m not very good at playing it.",
    options: [
      "across",
      "at",
      "by",
  ...
  {
    question:
      "Turn right _____ the end of the street and then it will be right in front of you.",
    options: [
      "across",
      "at",
      "by",
  ...
  {
    question:
      "She was _____ university when she heard about the death of her father.",
  ...
  {
    question:
      "She got _____ the bus at Oxford Street and got off five stops later.",
    options: ["at", "by", "for", "in", "on"],
    answer: "on",
  },
  {
  ...
  {
    question:
      "Dad always reads his daughter bedtime stories _____ the evening.",
    options: ["at", "by", "for", "in", "on"],
    answer: "in",
  },
  {
  ...
  {
    question:
      "The cat was playing with a ball _____ the corner of Michael's room.",
    options: ["at", "by", "for", "in", "on"],
    answer: "in",
  },
  {
  ...
  {
    question:
      "_____ average, the unemployment rate has been going up 1 per cent a year.",
    options: ["at", "by", "for", "in", "on"],
    answer: "on",
  },
  {
  ...
  {
    question:
      "The boss would like to have the report _____ the end of the day at the latest.",
    options: ["at", "by", "for", "in", "on"],
    answer: "by",
  },
  {
  ...
  {
    question:
      "We usually go on holidays _____ plane but this year we are going to Italy by car.",
    options: ["at", "by", "for", "in", "on"],
    answer: "by",
  },
  {
  ...
  {
    question:
      "I liked him _____ first, but then he started being bossy and arrogant.",
    options: ["at", "by", "for", "in", "on"],
    answer: "at",
  },
  {
  ...
  {
    question:
      "_____ your left you can see one of the biggest libraries in the world.",
    options: ["at", "by", "for", "in", "on"],
    answer: "on",
  },
  {
  ...
  {
    question:
      "My sister travelled to the Far East _____ the first time in her life.",
    options: ["at", "by", "for", "in", "on"],
    answer: "for",
  },
  {
    question:
      "_____ theory it was a good method, but we did not know if it would work in practice.",
    options: ["at", "by", "for", "in", "on"],
    answer: "in",
  },
  {
  ...
  {
    question:
      "_____ any case, the police have to catch the criminal before he causes any more harm.",
    options: ["at", "by", "for", "in", "on"],
    answer: "in",
  },
  {
  ...
  {
    question:
      "After the attack they found themselves _____ war with the enemy.",
    options: ["at", "by", "for", "in", "on"],
    answer: "at",
  },
  {
  ...
  {
    question:
      "John is _____ university and comes home every two or three months.",
    options: ["at", "by", "for", "in", "on"],
    answer: "at",
  },
  {
  ...
  {
    question:
      "She can't sleep _____ night and always needs to take some pills.",
    options: ["at", "by", "for", "in", "on"],
    answer: "at",
  },
  {
    question:
      "_____ all means, we must try to bring all the parties together and work out a solution.",
    options: ["at", "by", "for", "in", "on"],
    answer: "by",
  },
  {
  ...
  {
    question:
      "I didn't want to break the vase _____ purpose. It just slipped out of my hand.",
    options: ["at", "by", "for", "in", "on"],
    answer: "on",
  },
  {
  ...
  {
    question:
      "The _____ challenge in losing weight is changing your eating habits.",
    options: ["biggest", "largest"],
    answer: "biggest",
  },
  {
    question:
      "The number of people buying CDs is getting _____ every year as MP3s become more popular.",
  ...
  {
    question:
      "There was a _____ mistake in the report; we'll have to print a revised copy.",
    options: ["big", "large"],
    answer: "big",
  },
  {
  ...
  {
    question:
      "This foundation provides grants for _____ businesses in developing countries.",
    options: ["little", "small"],
    answer: "small",
  },
  {
  ...
  {
    question:
      "As the concert _____ to a close, the lead singer thanked the fans for their support.",
  ...
  {
    question:
      "It rained continuously for the first three days we were in Miami - a bit of a _____ start to our vacation.",
  ...
  {
    question:
      "The famous athlete talked about his _____ beginnings on his town's local basketball team.",
  ...
  {
    question:
      "There seems to be no end in _____ to the country's political conflicts.",
  ...
  {
    question:
      "You can't drive over that bridge because it is _____ repair at the moment.",
    options: [
      "across",
      "besides",
      "between",
  ...
  {
    question:
      "It took _____ an hour for the technicians to restore electricity.",
    options: [
      "across",
      "besides",
      "between",
  ...
  {
    question:
      "I almost never agree _____ him, but this time we shared the same opinion.",
    options: [
      "about",
      "against",
      "at",
  ...
  {
    question:
      "Students are protesting _____ increasing tuition fees at universities.",
    options: [
      "about",
      "against",
      "at",
  ...
  {
    question:
      "After the accident the ambulance took him to the hospital where he fell _____ a coma.",
    options: [
      "about",
      "against",
      "at",
  ...
  {
    question:
      "Catharine's parents disapproved _____ her marriage to the wealthy banker.",
    options: [
      "about",
      "against",
      "at",
  ...
  {
    question:
      "I always shop _____ my Christmas presents during the summer holidays.",
    options: [
      "about",
      "against",
      "at",
  ...
  {
    question:
      "After studying at university, she developed _____ a great scientist.",
    options: [
      "about",
      "against",
      "at",
  ...
  {
    question:
      "The dog barked _____ the delivery man when he came through the gate.",
    options: [
      "about",
      "against",
      "at",
  ...
  {
    question:
      "We must sympathize _____ those who have lost relatives in the conflict.",
    options: [
      "about",
      "against",
      "at",
  ...
  {
    question:
      "It took him a long time to recover _____ the accident he had last year.",
    options: [
      "about",
      "against",
      "at",
  ...
  {
    question:
      "The farmers in the region hoped _____ rain because the drought was destroying all the crops.",
    options: [
      "about",
      "against",
      "at",
  ...
  {
    question:
      "The police prevented the protesters _____ entering the building.",
    options: [
      "about",
      "across",
      "along",
  ...
  {
    question:
      "According _____ the latest report, the virus is spreading very quickly.",
    options: [
      "about",
      "across",
      "along",
  ...
  {
    question:
      "I don't know _____ certain, but I think she's on leave at the moment.",
    options: ["by", "for", "from", "in", "into", "on", "out of", "under"],
    answer: "for",
  },
  {
  ...
  {
    question:
      "_____ my opinion, she must be the greatest athlete of all times.",
    options: ["by", "for", "from", "in", "into", "on", "out of", "under"],
    answer: "in",
  },
  {
    question:
      "There is a big ceremony being held _____ honour of the killed soldiers.",
    options: ["by", "for", "from", "in", "into", "on", "out of", "under"],
    answer: "in",
  },
  {
  ...
  {
    question:
      "Many products sold at the market have been carefully manufactured _____ hand.",
    options: [
      "against",
      "at",
      "behind",
  ...
  {
    question:
      "Many of the trains leaving London are currently running _____ schedule.",
    options: [
      "against",
      "at",
      "behind",
  ...
  {
    question:
      "Many species in the Amazon rain forest are _____ risk of becoming extinct.",
    options: [
      "against",
      "at",
      "behind",
  ...
  {
    question:
      "My sister has been suffering _____ a nervous breakdown over the past few weeks.",
    options: [
      "against",
      "at",
      "behind",
  ...
  {
    question:
      "The journalist asked the politician a few things _____ the record.",
    options: [
      "against",
      "at",
      "behind",
  ...
  {
    question:
      "If global warming continues _____ the present rate sea levels will rise very quickly.",
    options: [
      "against",
      "at",
      "behind",
  ...
  {
    question:
      "We had access _____ the internet in all the hotels we stayed at.",
    options: ["to", "of", "for"],
    answer: "to",
  },
  {
    question:
      "We had access to the internet in all the hotels we stayed _____.",
    options: ["at", "in", "on"],
    answer: "at",
  },
  {
  ...
  {
    question:
      "_____ we saw the television show about bears, we drove to the zoo.",
  ...
  {
    question:
      "John is totally obsessed _____ football. He thinks of nothing else.",
  ...
  {
    question:
      "When I was younger I was always afraid _____ going to the dentist.",
  ...
  {
    question:
      "My father tells us fascinating stories _____ his years in the navy.",
  ...
  {
    question:
      "We didn’t see the whole performance because we left _____ the last act.",
  ...
  {
    question:
      "Has anyone _____ found my red fountain pen? I lost it yesterday.",
    options: ["by surprise", "at times", "by chance"],
    answer: "by chance",
  },
  {
    question:
      "Shorter skirts were _____ a few years ago but they aren't anymore today.",
  ...
  {
    question:
      "By the time someone got to the scene of the accident, the car was _____.",
    options: ["under repair", "on fire", "out of stock"],
    answer: "on fire",
  },
  {
    question:
      "I tried to convince her to take part in the course, but all my efforts were _____.",
  ...
  {
    question:
      "The headmaster cancelled the meeting _____ because he had to be somewhere else.",
  ...
  {
    question:
      "I'm sorry but this item is _____. We'll try to get it by next month.",
    options: ["under repair", "on leave", "out of stock"],
    answer: "out of stock",
  },
  {
    question:
      "He is _____ until the end of the year, so I'm afraid he won't be available for the planning stages.",
    options: ["on leave", "under stress", "in a good mood"],
    answer: "on leave",
  },
  {
    question:
      "The main bridge of the city is still _____, so you'll have to find another route across the river.",
    options: ["on fire", "under repair", "out of stock"],
    answer: "under repair",
  },
  {
    question:
      "The question took him _____, so he was struggling to find the right answer.",
    options: ["by surprise", "by chance", "at short notice"],
    answer: "by surprise",
  },
  {
    question:
      "Politicians sometimes make statements _____ that they later regret.",
  ...
  {
    question:
      "The new girl is shy _____, so you'll have to give her some time to open up.",
    options: ["by nature", "at times", "under stress"],
    answer: "by nature",
  },
  {
    question:
      "I wrote out the instructions _____ so she would know exactly what to do.",
    options: ["in public", "in conclusion", "in detail"],
    answer: "in detail",
  },
  {
    question:
      "_____, I feel like leaving this country and moving somewhere else.",
    options: ["At times", "By far", "In a good mood"],
    answer: "At times",
  },
  {
    question:
      "Because of the stormy weather many trains in the region are running _____.",
    options: ["on alert", "out of breath", "behind schedule"],
    answer: "behind schedule",
  },
  {
    question:
      "We were told by the travel agent to book _____ because the hotel is very popular among tourists.",
    options: ["in theory", "in advance", "in demand"],
    answer: "in advance",
  },
  {
    question:
      "I wanted to go to Spain over the extended weekend, but _____, I think I'll stay at home.",
    options: ["on second thoughts", "with the naked eye", "on and off"],
    answer: "on second thoughts",
  },
  {
    question:
      "The young woman was _____ for possessing a substantial amount of drugs.",
    options: ["under fire", "at risk", "under arrest"],
    answer: "under arrest",
  },
  {
    question:
      "They used to have _____ relationship, but at the moment they're seeing each other quite often.",
    options: ["out of shape", "on and off", "behind schedule"],
    answer: "on and off",
  },
  {
    question:
      "You can only see a few planets _____. To see the others, you need a telescope.",
    options: ["between the lines", "on display", "with the naked eye"],
    answer: "with the naked eye",
  },
  {
    question:
      "His plan seemed very good _____, but it didn't work out the way we wanted it to.",
    options: ["on second thoughts", "in theory", "in the long run"],
    answer: "in theory",
  },
  {
    question:
      "The President put troops and military advisers in the region _____, as a conflict seemed to be imminent.",
    options: ["behind schedule", "on alert", "under fire"],
    answer: "on alert",
  },
  {
    question:
      "Many tropical plants and animals are _____ of becoming extinct over the next few decades.",
  ...
  {
    question:
      "I can't compete with you at the moment because I'm completely _____ and need a few practice sessions.",
  ...
  {
    question:
      "Electric bikes are currently _____ and manufacturers cannot keep up with production.",
  ...
  {
    question:
      "The lieutenant's soldiers were _____, so he had to withdraw from the front lines.",
    options: ["under fire", "under arrest", "on alert"],
    answer: "under fire",
  },
  {
    question:
      "It will take some time but, _____, all schools will be equipped with modern technology.",
    options: ["in theory", "between the lines", "in the long run"],
    answer: "in the long run",
  },
  {
    question:
      "The negotiator was looking for a way to _____ the two sides together.",
    options: ["draw", "get", "bring"],
    answer: "bring",
  },
  {
    question:
      "He came into the room quietly so that he wouldn’t _____ attention.",
    options: ["catch", "do", "draw"],
    answer: "draw",
  },
  {
    question:
      "The politician promised to _____ change to his community if he was elected.",
    options: ["do", "bring", "get"],
    answer: "bring",
  },
  {
    question:
      "While mum was preparing meals, I helped her and _____ the laundry.",
  ...
  {
    question:
      "We have to _____ some more research before we can publish the results.",
    options: ["do", "bring", "get"],
    answer: "do",
  },
  {
  ...
  {
    question:
      "The mafia boss had his associates do everything for him, so he didn’t have to _____ his hands dirty.",
    options: ["get", "bring", "catch"],
    answer: "get",
  },
  {
    question:
      "I was sitting too close to the fire, so my newspaper _____ fire.",
  ...
  {
    question:
      "The journalists revealed some exciting details and _____ the crimes of the company to light.",
    options: ["brought", "caught", "drew"],
    answer: "brought",
  },
  {
    question:
      "Even though I am an adult I still _____ a kick out of putting toys together.",
    options: ["get", "bring", "do"],
    answer: "get",
  },
  {
    question:
      "You can’t behave like that. You must _____ a line between your private and professional life.",
  ...
  {
    question:
      "The four-leaf clover I got from my girlfriend _____ me luck at the test.",
    options: ["brought", "did", "got"],
    answer: "brought",
  },
  {
    question:
      "When the robber tried to escape from the bank the police were already waiting and _____ him red-handed.",
    options: ["caught", "drew", "brought"],
    answer: "caught",
  },
  {
    question:
      "If you don’t start learning more, you’ll _____ badly in the test next week.",
    options: ["do", "bring", "get"],
    answer: "do",
  },
  {
    question:
      "Arguing like this will _____ us nowhere. We must start from the beginning.",
  ...
  {
    question:
      "There must be something wrong with your mobile phone. I can't _____ you.",
    options: ["put up with", "get through to", "keep up"],
    answer: "get through to",
  },
  {
    question:
      "I _____ an old acquaintance of mine at the airport. I hadn't seen her in years.",
    options: ["turned down", "ran into", "slowed down"],
    answer: "ran into",
  },
  {
    question:
      "I told her to _____, otherwise she would crash into the car up front.",
  ...
  {
    question:
      "I cannot _____ your bad behaviour anymore. I'm calling your parents.",
  ...
  {
    question:
      "I _____ the manager's offer of a 10 percent raise. I demanded more.",
    options: ["got through to", "made up for", "turned down"],
    answer: "turned down",
  },
  {
    question:
      "We had to _____ the doctor because his condition was deteriorating.",
    options: ["send for", "take after", "stand for"],
    answer: "send for",
  },
  {
    question:
      "You shouldn't leave the children alone for so long or they'll _____ something bad.",
  ...
  {
    question:
      "Being a primary school teacher _____ a lot of nerves and patience.",
    options: ["goes with", "calls for", "looks into"],
    answer: "calls for",
  },
  {
    question:
      "All the employees had to _____ a form given to them by the personnel manager.",
    options: ["make out", "drop off", "fill in"],
    answer: "fill in",
  },
  {
    question:
      "Although he answered most of my questions, I had the feeling he was _____ something.",
    options: ["picking on", "getting up to", "keeping back"],
    answer: "keeping back",
  },
  {
    question:
      "The older boys always _____ the younger ones at the school playground. It's so disgusting.",
  ...
  {
    question:
      "The sun has just _____, so I expect the rest of the afternoon will be quite warm.",
  ...
  {
    question:
      "John and Marjorie have decided to _____ after being together for five years.",
    options: ["hang on", "break off", "give up"],
    answer: "break off",
  },
  {
    question:
      "The man _____ the room without knocking and told us about the accident that had just happened.",
    options: ["come out", "burst in", "get up to"],
    answer: "burst in",
  },
  {
    question:
      "It's difficult to _____ the licence plate number of the car over there. It's so far away.",
  ...
  {
    question:
      "The teacher wasn't paying attention, so he _____ an old trick I had played on him.",
    options: ["came up against", "fell for", "drew up"],
    answer: "fell for",
  },
  {
    question:
      "My parents always let me _____ until after midnight. It's very generous of them.",
    options: ["take off", "get by", "stay out"],
    answer: "stay out",
  },
  {
    question:
      "The noise _____ after the politician appeared in the middle of the crowd.",
  ...
  {
    question:
      "A black limousine _____ near the Capitol and the President got out.",
    options: ["died down", "took off", "drew up"],
    answer: "drew up",
  },
  {
    question:
      "The manager had _____ the new documents with his lawyers before making a decision.",
    options: ["found out", "gone through", "drawn up"],
    answer: "drawn up",
  },
  {
    question:
      "John _____ that his wife had been cheating on him and filed for divorce.",
    options: ["fell for", "came up against", "found out"],
    answer: "found out",
  },
  {
    question:
      "The company _____ some financial difficulties and had to close some of its factories.",
    options: ["lived up to", "stayed out", "came up against"],
    answer: "came up against",
  },
  {
    question:
      "Normally, planes _____ on time, but today there are delays due to the foggy weather.",
