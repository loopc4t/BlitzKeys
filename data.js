const sentences = [
  ...
  {
    question: "She began learning Russian when she reached the age of 45.",
    options: ["on", "with", "at"],
    answer: "at",
  },
  {
  ...
  {
    question: "I'll show you the picture _____ the palace we visited yesterday.",
    options: ["for", "with", "of"],
    answer: "of",
  },
  {
    question: "We can only get to the camp _____ foot because there are no roads.",
    options: ["with", "for", "on"],
    answer: "on",
  },
  {
  ...
  {
    question: " the end of next year, we will have made over $100,000.",
    options: ["In", "On", "By"],
    answer: "By",
  },
  {
  ...
  {
    question: "Philip waited _____ her at the movie theatre for over an hour.",
    options: ["on", "at", "for"],
    answer: "for",
  },
  {
  ...
  {
    question: "We are very proud _____ this company and everything it has achieved.",
    options: ["on", "with", "of"],
    answer: "of",
  },
  {
    question: "It's very kind _____ you to help us with the project.",
    options: ["to", "with", "of"],
    answer: "of",
  },
  {
    question: "He suffered _____ severe back pain for several years.",
    options: ["of", "on", "from"],
    answer: "from",
  },
  {
    question: "Please write the answer _____ pencil, not in pen.",
    options: ["on", "at", "in"],
    answer: "in",
  },
  {
    question: "It's _____ time you told him the truth about what happened.",
    options: ["at", "on", "about"],
    answer: "about",
  },
  {
    question: "The manager didn't take part _____ the discussion about the new policy.",
    options: ["of", "at", "in"],
    answer: "in",
  },
  {
    question: "He's very good _____ telling jokes and making people laugh.",
    options: ["in", "with", "at"],
    answer: "at",
  },
  {
    question: "I'll see you _____ the conference on Monday.",
    options: ["on", "for", "at"],
    answer: "at",
  },
  {
  ...
  {
    question: "We usually have turkey _____ Thanksgiving Day.",
    options: ["in", "for", "on"],
    answer: "on",
  },
  {
  ...
  {
    question: "She always looks _____ herself in the mirror before leaving the house.",
    options: ["on", "in", "at"],
    answer: "at",
  },
  {
  ...
  {
    question: "My friend always borrows money _____ me when he is short of cash.",
  ...
  {
    question: "He arrived at the school building just _____ time to take the exam.",
    options: ["at", "with", "in"],
    answer: "in",
  },
  {
    question: "The audience threw tomatoes _____ him after his terrible performance.",
    options: ["to", "with", "at"],
    answer: "at",
  },
  {
    question: "Passengers are not allowed to use cell phones _____ the plane during takeoff and landing.",
    options: ["at", "for", "on"],
    answer: "on",
  },
  {
    question: "He is responsible _____ what he does and must accept the consequences.",
    options: ["to", "of", "for"],
    answer: "for",
  },
  {
    question: "I'm sorry _____ the job you didn't get.",
    options: ["at", "with", "about"],
    answer: "about",
  },
  {
    question: "I'm very bad _____ mathematics and often need extra help.",
    options: ["in", "with", "at"],
    answer: "at",
  },
  {
    question: "He is always _____ time for work, even when the traffic is bad.",
    options: ["at", "with", "on"],
    answer: "on",
  },
  {
  ...
  {
    question: "A university is where you study _____ a degree in a particular subject.",
    options: ["at", "on", "for"],
    answer: "for",
  },
  {
  ...
  {
    question: "Many of us eat _____ a fork and spoon rather than using our hands.",
    options: ["by", "in", "with"],
    answer: "with",
  },
  {
  ...
  {
    question: "The TV is _____ the corner of the room next to the sofa.",
    options: ["at", "with", "in"],
    answer: "in",
  },
  {
  ...
  {
    question: "He might turn _____ a frog in the fairy tale.",
    options: ["to", "at", "into"],
    answer: "into",
  },
  {
    question: "He felt bad _____ making his friend wait so long.",
    options: ["with", "of", "for"],
    answer: "for",
  },
  {
    question: "I have been living here _____ ten years.",
    options: ["during", "since", "for"],
    answer: "for",
  },
  {
  ...
  {
    question: "I happened to meet an old friend _____ town while I was shopping.",
    options: ["at", "on", "in"],
    answer: "in",
  },
  {
    question: "I read about the accident _____ yesterday's newspapers.",
    options: ["at", "on", "in"],
    answer: "in",
  },
  {
  ...
  },
  {
    ...
    options: ["for", "at", "during"],
    answer: "during",
  },
  {
    question: "I want to post this letter _____ a friend who lives abroad.",
    options: ["for", "at", "to"],
    answer: "to",
  },
  {
  ...
  {
    question: "Mum sat _____ the back of the car during the long journey.",
    options: ["at", "on", "in"],
    answer: "in",
  },
  {
  ...
  {
    question: "It was _____ the radio yesterday morning that I heard the news.",
    options: ["at", "in", "on"],
    answer: "on",
  },
  {
  ...
  {
    question: "Meet me _____ the station at six o'clock.",
    options: ["on", "in", "at"],
    answer: "at",
  },
  {
    question: "The lights are moving _____ us as the car approaches.",
    options: ["from", "at", "towards"],
    answer: "towards",
  },
  {
    question: "My country is famous _____ its great musicians.",
    options: ["with", "of", "for"],
    answer: "for",
  },
  {
  ...
  {
    question: "Turn right _____ the end of the street, and you will see the bank.",
    options: ["in", "on", "at"],
    answer: "at",
  },
  {
    question: "She lives _____ the third floor of this building.",
    options: ["at", "in", "on"],
    answer: "on",
  },
  {
    question: "Mr. Brown will be _____ you in a moment. Please take a seat.",
    options: ["at", "for", "with"],
    answer: "with",
  },
  {
  ...
  {
    question: "Sometimes I go _____ bus instead of taking the train.",
    options: ["with", "on", "by"],
    answer: "by",
  },
  {
  ...
  },
  {
    ...
    options: ["at", "by", "through"],
    answer: "through",
  },
  {
    question: "There was a dark spot _____ the ceiling above the table.",
    options: ["at", "in", "on"],
    answer: "on",
  },
  {
  ...
  {
    question: "We have to be at the airport _____ 6 p.m., so we should leave now.",
    options: ["at", "in", "by"],
    answer: "by",
  },
  {
  ...
  },
{
  ...
  },
  {
    ...
    options: ["a close call", "a red flag", "a false alarm"],
  ...
  },
  {
    ...
    "options": ["total", "perfect", "spitting"],
    "answer": "spitting"
  },
  {
  ...
  {
    question: "She's terrified _____ spiders and refuses to go near them.",
    options: ["with", "at", "of"],
    answer: "of",
  },
  {
    question: "He apologized _____ the mistake he made.",
    options: ["of", "with", "for"],
    answer: "for",
  },
  {
    question: "The cat jumped _____ the table and knocked over the vase.",
    options: ["at", "in", "onto"],
    answer: "onto",
  },
  {
    question: "I'll be back _____ five minutes, so don't leave without me.",
    options: ["at", "on", "in"],
    answer: "in",
  },
  {
    question: "The children were divided _____ two teams for the competition.",
    options: ["at", "on", "into"],
    answer: "into",
  },
  {
  ...
  {
    question: "He blamed the delay _____ the terrible weather.",
    options: ["at", "of", "on"],
    answer: "on",
  },
  {
    question: "The company invested heavily _____ new technology last year.",
    options: ["at", "on", "in"],
    answer: "in",
  },
  {
    question: "We congratulated her _____ passing the exam with an excellent score.",
    options: ["of", "at", "on"],
    answer: "on",
  },
  {
    question: "The bridge was named _____ the town's founder, who built the first school there.",
    options: ["by", "at", "after"],
    answer: "after",
  },
  {
    question: "He's allergic _____ peanuts and has to avoid foods that contain them.",
    options: ["with", "at", "to"],
    answer: "to",
  },
  {
    question: "The teacher divided the class _____ small groups for the group project.",
    options: ["at", "on", "into"],
    answer: "into",
  },
  {
    question: "She's obsessed _____ true crime podcasts and listens to them every day.",
    options: ["at", "on", "with"],
    answer: "with",
  },
  {
    question: "The train departs _____ platform 4 at exactly 8:30 a.m.",
    options: ["at", "on", "from"],
    answer: "from",
  },
  {
    question: "He accused her _____ lying about the accident.",
    options: ["for", "at", "of"],
    answer: "of",
  },
  {
    question: "The workers went on strike _____ protest against the pay cuts.",
    options: ["for", "at", "in"],
    answer: "in",
  },
  {
    question: "I'm not very keen _____ seafood, so I'll order the chicken.",
    options: ["at", "with", "on"],
    answer: "on",
  },
  {
    question: "She translated the document _____ French into English for the international office.",
    options: ["at", "in", "from"],
    answer: "from",
  },
  {
    question: "The results were consistent _____ our expectations.",
    options: ["at", "on", "with"],
    answer: "with",
  },
  {
    question: "He's been suffering _____ insomnia for months and rarely gets a full night's sleep.",
    options: ["at", "in", "from"],
    answer: "from",
  },
  {
    question: "The choir sang _____ perfect harmony during the final song.",
    options: ["at", "on", "in"],
    answer: "in",
  },
  {
    question: "She's engaged _____ a man she met in college.",
    options: ["with", "at", "to"],
    answer: "to",
  },
  {
    question: "The company is known _____ its excellent customer service.",
    options: ["by", "at", "for"],
    answer: "for",
  },
  {
    question: "We were caught _____ the rain without an umbrella and arrived home completely soaked.",
    options: ["at", "on", "in"],
    answer: "in",
  },
  {
    question: "He insisted _____ paying for the whole meal, even though we offered to split the bill.",
    options: ["for", "at", "on"],
    answer: "on",
  },
  {
    question: "The dog was barking _____ the mailman as he approached the front door.",
    options: ["to", "for", "at"],
    answer: "at",
  },
  {
    question: "She's married _____ a doctor who works nights at the local hospital.",
    options: ["at", "with", "to"],
    answer: "to",
  },
  {
    question: "The novel is based _____ a true story about a family during the war.",
    options: ["at", "in", "on"],
    answer: "on",
  },
  {
    question: "He's terrible _____ remembering names, so he often forgets people's names.",
    options: ["in", "with", "at"],
    answer: "at",
  },
  {
